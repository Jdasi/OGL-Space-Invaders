...
// WINDOW SETTINGS
// ======================================================================================
static const int WINDOW_WIDTH                   = 620; // Width of the screen.
static const int WINDOW_HEIGHT                  = 600; // Height of the screen.
static const int WINDOW_MARGIN                  = 20;  // For determining playable area.
...
static const int MEGA_MODE_THRESHOLD            = 20;   // Score Multiplier to activate.
static const int EXTRA_LIFE_THRESHOLD           = 5000; // Score to achieve.
...
static const float ALIEN_SHOOT_DELAY_SOFT_MAX   = 1.0f; // Before addition of modifier.
...
static const int COLLISION_MANAGER_RESERVE      = 100; // For collision object list.
